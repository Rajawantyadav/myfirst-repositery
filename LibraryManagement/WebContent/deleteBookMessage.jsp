...
<body>
	...
	<div class="container-fluid">
		<h1 class="col-md-offset-5">
			<p>One Book data has been Deleted Successfully</p>
		</h1>

		<button type="button" class="btn btn-primary col-md-offset-5"
			id="view">
			<a href="ViewBook"><span
				class="glyphicon glyphicon-circle-arrow-left"></span> View Book</a>
		</button>


		<button type="button" class="btn btn-primary col-md-offset-3"
			id="back">
			<a href="DeleteBook.jsp"><span
